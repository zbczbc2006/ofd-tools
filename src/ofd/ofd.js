...
export { digestCheckProcess as digestCheck } from './ses_signature_parser'
export { getPageScale, setPageScale } from './ofd_util'
...
const doParseOFD = function (options) {
  ...
  pipeline
    .call(this, async () => await unzipOfd(options.ofd), getDocRoots, parseSingleDoc)
    .then((res) => {
      if (options.success) {
        options.success(res)
      }
