  ...
  try {
    ...
    const timeInfo = decodeUTCTime(
      asn1.sub[0]?.sub[2]?.stream.parseTime(
        ...
        asn1.sub[0].sub[2].stream.pos + asn1.sub[0].sub[2].header + asn1.sub[0].sub[2].length,
        false
      )
    )
    ...
    SES_Signature = {
      ...
      toSign: {
        ...
        dataHash: asn1.sub[0]?.sub[3]?.stream.hexDump(
          ...
          asn1.sub[0].sub[3].stream.pos + asn1.sub[0].sub[3].header + asn1.sub[0].sub[3].length,
          false
        ),
